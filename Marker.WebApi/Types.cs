...
public record CMarker(long Id, string OpenId, double Latitude, double Longitude, string Content, long TagId, string Tag, List<string> Images, bool Share = true);

public record CTag(long Id, string Name, bool Share = true);

public record MarkerResult(long Id, double Latitude, double Longitude, string Content, long TagId, string Tag);
